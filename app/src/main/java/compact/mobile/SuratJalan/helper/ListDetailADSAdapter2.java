...
public class ListDetailADSAdapter2 extends BaseAdapter{
	...
	public ListDetailADSAdapter2(Context context, ArrayList<HashMap<String, String>> daftar_list_ads_detail){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.list_ads_detail_adapter, null);
	
        // get current item to be displayed
//        HashMap<String, String> item = (HashMap<String, String>) getItem(position);
        
        // get the TextView for item name and item description
        holder.mNoAWB = (TextView) convertView.findViewById(R.id.isi_no_awb);
        holder.mStatus = (TextView) convertView.findViewById(R.id.isi_status);
        holder.mService = (TextView) convertView.findViewById(R.id.isi_service);
        holder.mType = (TextView) convertView.findViewById(R.id.isi_type);
        holder.mcheckText = (TextView) convertView.findViewById(R.id.txt_selected);
        holder.mcheck = (CheckBox) convertView.findViewById(R.id.selected);
        holder.checked = (ImageView) convertView.findViewById(R.id.checked);
        holder.unchecked = (ImageView) convertView.findViewById(R.id.unchecked);
...
//			holder.unchecked.setVisibility(View.VISIBLE);
        ...
        Picasso.with(holder.checked.getContext()).load(R.drawable.checked_icon).into(holder.checked);
		Picasso.with(holder.unchecked.getContext()).load(R.drawable.unchecked_icon).into(holder.unchecked);
