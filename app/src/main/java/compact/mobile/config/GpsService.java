...
//	private static final long	MIN_JARAK_GPS_UPDATE	= 10;				// meter
	private static final long	MIN_JARAK_GPS_UPDATE	= 100;				// meter

	// GPS akan update pada waktu interval
//	private static final long	MIN_WAKTU_GPS_UPDATE	= 1000 * 60 * 1;
	private static final long	MIN_WAKTU_GPS_UPDATE	= 200000;
...
//					Toast.makeText(this, "Koneksi Internet Aktif" , Toast.LENGTH_SHORT).show();
					if (locManager != null)
					{
...
//	public void showSettingAlert(String provider)
	{
		...
		// pesan alert
		alertDialog.setMessage("GPS tidak aktif. Ingin masuk ke setting GPS ?");
