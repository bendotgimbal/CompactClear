...
public class gps_tracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 9000 ; // 9 detik
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        nprovider = locationManager.getBestProvider(criteria, false);
                        Log.d("Provider", "provider -> " + nprovider);
                    	if (nprovider.equals("")) {
                        	nprovider = LocationManager.NETWORK_PROVIDER;
                        }
                    	location = locationManager
                                .getLastKnownLocation(nprovider);
                        if (location != null) {
